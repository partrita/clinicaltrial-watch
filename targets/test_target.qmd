...
<a href="../data/targets/test_target/all_trials_raw.csv" class="btn btn-primary" role="button" aria-label="Download all raw trial data for Test Target in CSV format">📥 Download Full Data (CSV)</a>
<a href="../data/targets/test_target/status_summary.csv" class="btn btn-outline-secondary" role="button" aria-label="Download status summary for Test Target in CSV format">📥 Download Status Summary (CSV)</a>
