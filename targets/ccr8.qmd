...
<a href="../data/targets/ccr8/all_trials_raw.csv" class="btn btn-primary" role="button" aria-label="Download all raw trial data for CCR8 in CSV format">📥 Download Full Data (CSV)</a>
<a href="../data/targets/ccr8/status_summary.csv" class="btn btn-outline-secondary" role="button" aria-label="Download status summary for CCR8 in CSV format">📥 Download Status Summary (CSV)</a>
